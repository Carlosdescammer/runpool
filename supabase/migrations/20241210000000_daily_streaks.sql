-- Migration to add daily streak tracking
-- This will track daily activities and calculate streaks for user engagement

-- Daily activities table to track daily interactions
...
-- User streaks table to track current and best streaks
...
-- Trigger to automatically update streaks when activities are inserted
...
-- Add trigger to update streaks table
...
-- Update existing trigger for profiles to handle streak updates
