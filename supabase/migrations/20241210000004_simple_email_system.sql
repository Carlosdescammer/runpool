-- Simple email campaign system that works with auth.users
-- This version doesn't depend on a profiles table

-- First, let's create a simple profiles table if it doesn't exist
...
-- Function to get user email preferences (simplified)
...
-- Function to update email preferences (simplified)
