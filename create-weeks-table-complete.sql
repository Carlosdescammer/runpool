-- Complete weeks table setup with all dependencies
...
DROP POLICY IF EXISTS "Users can view weeks for their groups" ON public.weeks;
DROP POLICY IF EXISTS "Group admins can manage weeks" ON public.weeks;
...
DROP TRIGGER IF EXISTS update_weeks_updated_at ON public.weeks;
